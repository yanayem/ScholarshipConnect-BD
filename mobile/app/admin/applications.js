...
// Fake data for demo
const INITIAL_APPS = [
  { id: '1', user: 'Anisur Rahman', program: 'MEXT Japan 2025', date: '2 hours ago', status: 'New' },
  { id: '2', user: 'Farzana Yasmin', program: 'Chevening UK', date: '5 hours ago', status: 'Checked' },
  { id: '3', user: 'Sabbir Ahmed', program: 'Fulbright USA', date: 'Yesterday', status: 'Approved' },
];
    ...
    <View style={styles.card}>
      <View style={styles.cardInfo}>
        ...
        <View style={[styles.statusBadge, {
            backgroundColor: item.status === 'New' ? theme.colors.primaryLight : '#F1F5F9'
        }]}>
            <Text style={[styles.statusText, {
                color: item.status === 'New' ? theme.colors.primary : theme.colors.textSecondary
            }]}>{item.status}</Text>
        </View>
      </View>
