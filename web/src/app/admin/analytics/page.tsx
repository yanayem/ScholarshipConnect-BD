      ...
      <main className="max-w-7xl mx-auto px-6 py-10 lg:py-16">
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
            <div className="flex items-center gap-6">
                <div className="w-16 h-16 bg-emerald-50 rounded-none flex items-center justify-center text-emerald-600">
                    <TrendingUp size={32} />
                </div>
                <div>
            ...
            <div className="flex gap-4">
                <button className="px-6 py-3 bg-white border border-slate-200 rounded-none font-bold text-xs uppercase tracking-widest text-slate-600 hover:bg-slate-50 transition-all flex items-center gap-2">
                    <Calendar size={16} />
                    Last 30 Days
                </button>
                <button className="px-6 py-3 bg-slate-900 text-white rounded-none font-bold text-xs uppercase tracking-widest hover:bg-slate-800 transition-all flex items-center gap-2 shadow-xl shadow-slate-200">
                    <Download size={16} />
                    Export PDF
                </button>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 bg-white border border-slate-200 rounded-none p-10 shadow-sm min-h-[400px] flex flex-col justify-center items-center text-center">
                ...
                <div className="mt-10 flex gap-2 w-full max-w-sm">
                    {[30, 60, 45, 90, 70, 100, 80].map((h, i) => (
                        <div key={i} className="flex-1 bg-emerald-100 rounded-none transition-all hover:bg-emerald-500" style={{ height: `${h}px` }}></div>
                    ))}
                </div>
            </div>
