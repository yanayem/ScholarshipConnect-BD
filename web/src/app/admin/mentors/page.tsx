      ...
      <main className="max-w-7xl mx-auto px-6 py-10 lg:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {loading ? (
                ...
                <div className="col-span-full bg-white border border-slate-200 rounded-[2rem] p-20 text-center shadow-sm">
                ...
                <div key={app.id} className="bg-white border border-slate-200 rounded-[2rem] p-8 shadow-sm hover:border-primary/20 transition-all group">
                    <div className="flex items-start gap-6 mb-8">
                        <div className="w-20 h-20 bg-primary-light rounded-[1.5rem] flex items-center justify-center text-primary text-2xl font-black shadow-sm overflow-hidden shrink-0">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="flex flex-wrap gap-2">
                                ...
                                {app.is_pro && (
                                    <span className="bg-amber-50 text-amber-600 px-3 py-1 rounded-lg text-[10px] font-black uppercase tracking-widest border border-amber-100">Pro Tier</span>
                                )}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-3">
                        <button
                            ...
                            className="flex-1 py-4 bg-primary text-white rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-primary-dark transition-all shadow-xl shadow-primary/20"
                        >
                            Approve
                        </button>
                        <button
                            onClick={() => handleApprove(app.id, 'rejected')}
                            className="flex-1 py-4 bg-white border border-slate-200 text-slate-400 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-red-50 hover:text-red-500 hover:border-red-100 transition-all"
                        >
                            Decline
                        </button>
                    </div>
