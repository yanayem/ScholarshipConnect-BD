    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto px-6 py-10 lg:py-16">
        ...
        <header className="flex items-center gap-6 mb-12">
            <div className="w-16 h-16 bg-slate-900 rounded-none flex items-center justify-center text-white">
                <Settings size={32} />
            </div>
            <div>
        ...
        <div className="space-y-8">
            <section className="bg-white border border-slate-200 rounded-none p-10 shadow-sm">
            ...
            <section className="bg-white border border-slate-200 rounded-none p-10 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" defaultValue={10} className="w-full bg-slate-50 border border-slate-100 rounded-none p-4 text-slate-900 font-medium outline-none focus:ring-2 focus:ring-primary/20 transition-all" />
                    </div>
                    <div>
                        ...
                        <input type="number" defaultValue={50} className="w-full bg-slate-50 border border-slate-100 rounded-none p-4 text-slate-900 font-medium outline-none focus:ring-2 focus:ring-primary/20 transition-all" />
                    </div>
                    <div className="md:col-span-2">
                        ...
                        <input type="email" defaultValue="support@scholarshipconnect.bd" className="w-full bg-slate-50 border border-slate-100 rounded-none p-4 text-slate-900 font-medium outline-none focus:ring-2 focus:ring-primary/20 transition-all" />
                    </div>
                </div>
            </section>
            ...
            <section className="bg-white border border-slate-200 rounded-none p-10 shadow-sm">
                ...
                <div className="space-y-4">
                    <div className="flex items-center gap-4 p-4 border border-slate-100 rounded-none">
                        <div className="w-10 h-10 bg-slate-50 rounded-none flex items-center justify-center font-bold text-blue-600">F</div>
                    ...
                    <div className="flex items-center gap-4 p-4 border border-slate-100 rounded-none">
                        <div className="w-10 h-10 bg-slate-50 rounded-none flex items-center justify-center font-bold text-indigo-600">S</div>
                        <div className="flex-1">
            ...
            <button
                onClick={handleSave}
                disabled={saving}
                className="w-full py-5 bg-slate-900 text-white rounded-none font-black text-xs uppercase tracking-widest hover:bg-slate-800 transition-all shadow-2xl shadow-slate-200 flex items-center justify-center gap-3 disabled:opacity-50"
            >
