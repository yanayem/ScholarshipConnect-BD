...
const styles = StyleSheet.create({
  ...
  logoCircle: {
    ...
    elevation: 5, shadowColor: '#1565C0', shadowOpacity: 0.3, shadowRadius: 10,
  },
  ...
  forgotPassText: { color: '#1565C0', fontWeight: '600', fontSize: 14 },
  loginBtn: {
    backgroundColor: '#1565C0', borderRadius: 12, height: 56,
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    gap: 8, elevation: 3, shadowColor: '#1565C0', shadowOpacity: 0.3, shadowRadius: 6,
  },
  loginBtnText: { color: '#fff', fontSize: 18, fontWeight: 'bold' },
  divider: { flexDirection: 'row', alignItems: 'center', marginVertical: 30 },
  line: { flex: 1, height: 1, backgroundColor: '#CFD8DC' },
  dividerText: { marginHorizontal: 16, color: '#90A4AE', fontWeight: 'bold' },
  ...
  signupText: { color: '#1565C0', fontSize: 15, fontWeight: 'bold' },
});
